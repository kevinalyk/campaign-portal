  ...
  return (
    <div className="container py-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold mb-8">Campaign Portal Terms of Service</h1>

        <div className="space-y-6 text-lg">
          <p>
            These Terms of Service govern your use of the website located at{" "}
            <a
              href="https://campaignportal.ai"
              className="text-blue-600 hover:underline"
              target="_blank"
              rel="noopener noreferrer"
            >
              https://campaignportal.ai
            </a>{" "}
            and any related services provided by Campaign Portal.
          </p>
          ...
          <p>
            ...
            you do not agree with these Terms of Service, you are prohibited from using or accessing this website or
            using any other services provided by Campaign Portal.
          </p>

          <p>
            We, Campaign Portal, reserve the right to review and amend any of these Terms of Service at our sole
          ...
          <p>These Terms of Service were last updated on March 20, 2025.</p>

          <h2 className="text-2xl font-bold mt-10 mb-4">Limitations of Use</h2>
          <p>
            By using this website, you warrant on behalf of yourself, your users, and other parties you represent that
            you will not:
          </p>
          ...
          <ul className="list-disc pl-8 space-y-2 my-4">
            ...
            <li>
              ...
              disrupts our networks or any other service Campaign Portal provides;
            </li>
            <li>
          ...
          <p>
            The intellectual property in the materials contained in this website are owned by or licensed to Campaign
            Portal and are protected by applicable copyright and trademark law. We grant our users permission to
          ...
          <p>
            ...
            if you violate any of these restrictions or the Terms of Service, and may be terminated by Campaign Portal
            at any time.
          </p>
          ...
          <p>
            ...
            website. We will never claim ownership of your content, but we do require a license from you in order to use
            it.
          </p>

          <p>
            When you use our website or its associated services to post, upload, share, or otherwise transmit content
          ...
          <p>
            ...
            extent that we (or our partners) have used your content in connection with commercial or sponsored content,
            the license will continue until the relevant commercial or post has been discontinued by us.
          </p>

          <p>
            You give us permission to use your username and other identifying information associated with your account
            in a manner that is consistent with your privacy preferences and our Privacy Policy.
          </p>

          <h2 className="text-2xl font-bold mt-10 mb-4">Liability</h2>
          <p>
            Our website and the materials on our website are provided on an 'as is' basis. To the extent permitted by
            law, Campaign Portal makes no warranties, expressed or implied, and hereby disclaims and negates all other
          ...
          <p>
            In no event shall Campaign Portal or its suppliers be liable for any consequential loss suffered or incurred
            by you or any third party arising from the use or inability to use this website or the materials on this
            website, even if Campaign Portal or an authorized representative has been notified, orally or in writing, of
            the possibility of such damage.
          </p>

          <p>
            In the context of this agreement, "consequential loss" includes any consequential loss, indirect loss, real
            or anticipated loss of profit, loss of benefit, loss of revenue, loss of business, loss of goodwill, loss of
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4">Accuracy of Materials</h2>
          <p>
            The materials appearing on our website are not comprehensive and are for general information purposes only.
            Campaign Portal does not warrant or make any representations concerning the accuracy, likely results, or
          ...
          <p>
            Campaign Portal has not reviewed all of the sites linked to its website and is not responsible for the
            contents of any such linked site. The inclusion of any link does not imply endorsement, approval or control
            by Campaign Portal of the site. Use of any such linked site is at your own risk and we strongly advise you
            make your own investigations with respect to the suitability of those sites.
          </p>

          <h2 className="text-2xl font-bold mt-10 mb-4">Right to Terminate</h2>
          <p>
          ...
          <h2 className="text-2xl font-bold mt-10 mb-4">Severance</h2>
          <p>
            Any term of these Terms of Service which is wholly or partially void or unenforceable is severed to the
          ...
          <p>
            These Terms of Service are governed by and construed in accordance with the laws of NM. You irrevocably
